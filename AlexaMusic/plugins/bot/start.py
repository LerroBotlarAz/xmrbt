...
async def alive(client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ Salam, Alexa işləyir və düzgün fəaliyyət göstərir.\n✪ Xəzər Project 🌼 ..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ Sahib    : [Lerro](https://t.me/Lerrodu)\n┣★ Yeniliklər › : [Yenilikər](https://t.me/Xezer_Botlar)┓\n┣★ Support › : [Dəstək](https://t.me/Xezer_Destek)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 Əgər hər hansı sualınız varsa, onda mənim [Sahibimə](https://t.me/Lerrodu) yazın və ya layihəmizi başlamağa zəmanət verin. ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("✪ Dəstək", url=config.SUPPORT_GROUP)]]
        ),
    )
...
async def verify(client, message: Message):
    if await is_served_user(message.from_user.id):
        await message.reply_text(
            text="ChatGPT сказал: 😂 Əzizim, sən artıq təsdiqlənmisən.",
        )
        return
    await add_served_user(message.from_user.id)
    await message.reply_photo(
